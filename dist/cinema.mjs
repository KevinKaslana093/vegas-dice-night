...
export const CINEMA_ASSETS={
 portraits:['./assets/denim-cutin.png','./assets/cowboy-cutin.png','./assets/owner-cutin.png','./assets/bunny-cutin.png','./assets/dealer-cutin.webp','./assets/magician-cutin.webp'],
...
export function createCinema({names,colors,skills,die,prefs}){
 ...
 function sting(actor){if(!prefs().sound||document.hidden)return;try{audioContext??=new AudioContext();audioContext.resume();
  const now=audioContext.currentTime,notes=[[440,660,880],[130,98,65],[196,247,294],[587,740,880],[330,495,660],[392,494,784]][actor];
 ...
 function resultMarkup(e){const role=e.role??e.actor;if(role>=4)return `<div class="new-skill-prop">${role===4?'♠':'✦'}</div><h3>${role===4?'精准发牌':'袖中乾坤'}</h3><p>${safe(e.label||'已改变自己的掷骰结果')}</p>`;
