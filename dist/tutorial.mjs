import {createGame,rollDice,placeDice,skipTurn,useSkill,miniAction,outcome,previewTable,claimChange,banknoteOwners,NAMES,COLORS,EFFECTS,bigCount,tableWeight,isBigRoll} from './core.mjs';
...
export const LESSON_STEPS=[
 ['next','序幕','第二课，试试更多花样。','基础已经会了。这一轮再试大骰、技能、筹码和特殊桌；随时可以退出，之后再学。','牛仔：那就请你带路。'],
 ...
 ['next','下一桌','正式牌局使用新版技能。','正式新版里丹宁小姐9小＋1大；老板至少付2枚筹码，以本桌1颗普通骰换对手计数2或3的组合。我随机展示对手两张钱，选一张，用自己的旧钞票交换。技能都有限制，派彩后我仍可发动。','牛仔：看来还得提防你。','players'],
