async(page)=>{
 ...
 await page.addInitScript(g=>{if(!sessionStorage.getItem('mini-v5-fixture-used')){localStorage.setItem('vegas-night-save-v5',JSON.stringify(g));sessionStorage.setItem('mini-v5-fixture-used','1');}},fixture);
 await page.reload();await page.setViewportSize({width:390,height:844});
 await page.screenshot({path:'output/playwright/v5-characters.png',fullPage:true});
 ...
 await page.screenshot({path:'output/playwright/v5-minigame.png',fullPage:true});
